...
class ImagePath:
    ...
    def __init__(self, imagefile, imagetype=IMAGE_TYPE_HD, partition=None,
                 filepath="/"):
    ...
    def parse(s):
        ...
        if not ":" in parsed.netloc:
            raise PathParseError("Image type hd, fd or cdrom needed after the "
                                 "image file name and a ':'")
        ...
        if imagetype == "hd":
            ...
            raise PathParseError("Image type %s unknown/unspported" %
                                 imagetype)
