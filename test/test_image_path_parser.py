...
class TestImagePathParser:
    def testValidFullPath(self):
        path_string = \
            "image://imagefile.img:hd/partition0/directory/somefile.dat"
    ...
    def testUnsupportedScheme(self):
        ...
        pytest.raises(image_path.PathParseError, image_path.ImagePath.parse,
                      path_string)
    ...
    def testUnsupportedImageType(self):
        path_string = \
            "image://imagefile.img:some_image_type/directory/somefile.dat"
